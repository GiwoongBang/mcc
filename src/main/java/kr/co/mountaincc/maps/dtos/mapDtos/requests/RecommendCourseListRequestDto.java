...
public class RecommendCourseListRequestDto {
    ...
    @Schema(description = "코스명", example = "기을 단풍 코스", required = true)
    ...
    @ArraySchema(
            arraySchema = @Schema(description = "RecommendCourseRequestDto 리스트"),
            schema = @Schema(implementation = RecommendCourseRequestDto.class)
    )
    @NotEmpty(message = "RecommendCourseRequestDto 리스트는 비어 있을 수 없습니다.")
    @Valid
    private List<RecommendCourseRequestDto> gpxMappings;
